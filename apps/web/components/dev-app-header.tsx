            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              <nav className="flex items-center gap-2">
                {coachSecondaryDesktopLinks.map((link) => (
                  <div
                    key={link.childHref}
                    className="rounded-full border border-[var(--border-subtle)] px-2 py-1.5 min-h-[36px] inline-flex items-center gap-2 text-[11px] font-semibold uppercase tracking-wide md:whitespace-nowrap"
                  >
