      ...
      {open ? (
        <>
          ...
          <div
            ...
            className="absolute right-0 z-50 mt-2 w-56 overflow-hidden rounded-2xl border border-[var(--border-subtle)] bg-[var(--bg-card-solid)] shadow-[0_18px_48px_-32px_rgba(15,23,42,0.55)]"
          >
  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-50 bg-[var(--bg-page)] px-0 pt-0 md:px-0 md:pt-0">
        ...
        <div data-desktop-header="v1" className="hidden md:flex items-center justify-between gap-4 px-5 py-0">
