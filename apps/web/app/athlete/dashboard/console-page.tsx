  ...
  return (
    <>
      <section className={cn(tokens.spacing.screenPadding, 'pb-10')}>
        ...
        <div className="mt-4">
          <div className={cn('grid grid-cols-1 min-w-0 items-start min-[900px]:grid-cols-2 xl:grid-cols-40', tokens.spacing.gridGap)}>
            <div className="min-w-0 order-2 md:order-2 xl:col-span-9">
            ...
            <div className="min-w-0 order-1 md:order-1 xl:col-span-12">
              <Block
            ...
            <div className="min-w-0 order-3 md:order-3 md:col-span-2 xl:col-span-12">
              <AtAGlanceCard
            ...
            <div className="min-w-0 order-4 md:order-4 md:col-span-2 xl:col-span-7">
              <Block
