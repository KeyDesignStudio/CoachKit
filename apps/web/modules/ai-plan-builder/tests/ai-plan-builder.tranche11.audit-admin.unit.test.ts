...
describe('AI Plan Builder v1 (Tranche 11A: admin audit access)', () => {
  it('admin role is allowed', () => {
    const env: NodeJS.ProcessEnv = { NODE_ENV: 'test', [AI_PLAN_BUILDER_ADMIN_EMAILS_ENV]: '' };
  ...
  it('listed admin email is allowed', () => {
    const env: NodeJS.ProcessEnv = { NODE_ENV: 'test', [AI_PLAN_BUILDER_ADMIN_EMAILS_ENV]: 'admin@example.com, other@example.com' };
  ...
  it('non-admin is blocked when not listed', () => {
    const env: NodeJS.ProcessEnv = { NODE_ENV: 'test', [AI_PLAN_BUILDER_ADMIN_EMAILS_ENV]: 'admin@example.com' };
  ...
  it('parses env list defensively', () => {
    const env: NodeJS.ProcessEnv = { NODE_ENV: 'test', [AI_PLAN_BUILDER_ADMIN_EMAILS_ENV]: ' , A@b.com,  ,c@d.com ' };
